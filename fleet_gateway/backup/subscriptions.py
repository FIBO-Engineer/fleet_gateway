...
# from ..backup.data_loaders import load_robot_with_holdings, load_request
...
class Subscription:
    ...
    async def robot_updates(self, info: strawberry.types.Info, name: str) -> AsyncGenerator[Robot]:
    ...
    @strawberry.subscription
    async def request_updates(self, info: strawberry.types.Info, uuid: UUID) -> AsyncGenerator[Request]:
        """
